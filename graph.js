...
function drawChart(selectedParameter) {
    ...
    const insightsByParameter = {
      "Solar8000/HR": `
        <ul>
            <li>Heart Rate (HR) is the number of heartbeats per minute, indicating how quickly the heart is beating.</li>
            <li>A key indicator of cardiac function and stress response; helps detect arrhythmias or abnormal rhythms.</li>
      ...
      "Solar8000/ART_DBP": `
        <ul>
          <li><strong>Diastolic Blood Pressure (DBP) is the arterial pressure when the heart rests between beats.</li>
            <li><strong>Assesses vascular resistance and resting arterial pressure; high or low DBP can signal circulatory issues.</li>
      ...
      "Solar8000/ART_SBP": `
        <ul>
          <li><strong>Systolic Blood Pressure (SBP) is the peak arterial pressure during heart contraction (systole).</li>
            <li><strong>Evaluates how forcefully the heart pumps; helps identify hypertension or hypotension.</li>
      ...
      "Solar8000/ETCO2": `
        <ul>
          <li>End-Tidal CO<sub>2</sub> (ETCO<sub>2</sub>) is the partial pressure of CO<sub>2</sub> at the end of an exhaled breath.</li>
            <li>Reflects ventilation and perfusion; used to monitor respiratory status, sedation levels, and confirm airway placement.</li>
      ...
      "Solar8000/PLETH_SPO2": `
        <ul>
          <li>Peripheral Oxygen Saturation (SpO<sub>2</sub>) indicates the percentage of hemoglobin binding sites occupied by oxygen.</li>
        <li>Monitors oxygenation levels; helps detect hypoxemia and assess respiratory function.</li>
